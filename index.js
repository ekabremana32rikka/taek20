...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const apiKey = 'beli api key biar work!'
			...
			mess = {
				wait: '𝖳𝗎𝗇𝗀𝗀𝗎....𝖩𝖺𝗇𝗀𝖺𝗇 𝖡𝗈𝗌𝖺𝗇𝖡𝗈𝗌𝖺𝗇 𝗎𝗇𝗍𝗎𝗄 𝗆𝖾𝗇𝗎𝗇𝗀𝗀𝗎 𝗒𝖺 𝗄𝖺𝗄',
				asik: '𝖳𝗎𝗇𝗀𝗀𝗎....𝖩𝖺𝗇𝗀𝖺𝗇 𝖡𝗈𝗌𝖺𝗇𝖡𝗈𝗌𝖺𝗇 𝗎𝗇𝗍𝗎𝗄 𝗆𝖾𝗇𝗎𝗇𝗀𝗀𝗎 𝗒𝖺 𝗄𝖺𝗄',
				success: '𝖸𝖾𝖺𝗒 𝖡𝖾𝗋𝗁𝖺𝗌𝗂𝗅 𝖧𝗈𝗋𝖾𝖾...!',
				...
				only: {
					...
					mod: 'Maaf Kak Fitur Ini Untuk User Mods Veerbotz',
			...
			switch(command) {
				...
				if (!isUser) return reply(mess.only.userB)
			       ...
			       case 'valxlove':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMIN VEERBOTZ ✨* 」\n*│+wa.me/628pasangnomoryou*╰──────*「 *VEERBOTZ* 」*────*\n\n*_JIKA INGIN MENJADI ADMIN  VEERBOTZ_*\n*_Ketik /iklan_*' })
					break
					case 'premiumcek':
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					sa = await getBuffer(`https://i.ibb.co/PcQ6tsB/79ac87b9358c.jpg`)
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+wa.me/628pasangnomoryou*╰──────*「 *VEERBOTZ* 」*────*\n\n*_JIKA INGIN MENJADI PREMIUM USER  VEERBOTZ_*\n*_Ketik /daftarvip*' })
					break
					case 'cekmod': 
           ...
           if (!isUser) return reply(mess.only.userB)
            ...
            break
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (args.length < 1) return reply(`Parameter Salah\nCommand : ${prefix}daftar nama|umur\nContoh : ${prefix}daftar VEERBOTZ|12`)
 ...
 if (!isOwner) return reply(mess.only.ownerB)
            ...
            break
				...
				if (!isUser) return reply(mess.only.userB)
					...
					sholat = body.slice(9)
					anu = await fetchJson(`https://tobz-api.herokuapp.com/api/jadwalshalat?q=${sholat}&apikey=Jsieu8287362jshre82`, {method: 'get'})
					reply(mess.wait)
				...
				case 'testing':
					...
					if (args.length < 1) return reply('Teksnya mana um')
					reply(mess.wait)
					anu = await fetchJson(`https://api-zeks.harispoppy.com/api/watercolour?text1=${gbl38}&text2=${gbl48}&apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
                      ...
                      naon = body.slice(9)
                      reply(mess.wait)
                      anu = await fetchJson(`https://arugaz.my.id/api/textpro/neonlight?text=${naon}&apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (args.length < 1) return reply('Teksnya mana um')
					reply(mess.wait)
					anu = await fetchJson(`https://api-zeks.harispoppy.com/api/snowwrite?text1=${gbl7w}&text2=${gbl8w}&apikey=Jsieu8287362jshre82`, {method: 'get'})
...
if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					...
					if (args.length < 1) return reply('Teksnya mana um')
					reply(mess.wait)
					anu = await fetchJson(`https://api-zeks.harispoppy.com/api/marvellogo?text1=${dgbl5}&text2=${dgbl6}&apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (args.length < 1) return reply('Teksnya mana um')
					reply(mess.wait)
					anu = await fetchJson(`https://api-zeks.harispoppy.com/api/gplaybutton?text=${gol}&apikey=Jsieu8287362jshre82`, {method: 'get'})
					...
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=metal_dark_gold&text=${tels}&apiKey=Jsieu8287362jshre82`, {method: 'get'})
				...
				case 'textblue':
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=blue_metal&text=${tels}&apiKey=Jsieu8287362jshre82`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
				case 'textsky':
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=sky_online&text=${tels}&apiKey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (args.length < 1) return reply('Teksnya mana um')
					reply(mess.wait)
					anu = await fetchJson(`https://api-zeks.harispoppy.com/api/splaybutton?text=${gol2}&apikey=Jsieu8287362jshre82`, {method: 'get'})
          ...
          if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(mess.wait)
					gto = await getBuffer(`https://api-zeks.harispoppy.com/api/watercolour?text1=${ckj}&text2=${ckj2}&apikey=Jsieu8287362jshre82`)
				...
				if (!isUser) return reply(mess.only.userB)
                      ...
                      gl2n = geh.split("|")[1];
                      reply(mess.wait)
                      anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=ninjalogo&text1=${gl1n}&text2=${gl2n}&apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (args.length < 1) return reply(mess.blank)
					reply(mess.wait)
					anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=glitch&text1=${tels3}&text2=${tels4}&apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				case 'embuntext':
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=dropwater&text=${tels}&apiKey=Jsieu8287362jshre82`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
				case 'fire':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api-zeks.harispoppy.com/api/tfire?text=${tels}&apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`https://api-zeks.harispoppy.com/api/tlight?text=${telsf}&apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
                      ...
                      glq2 = gqh.split("|")[1];
                      reply(mess.wait)
                      anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=wolflogo1&text1=${glq1}&text2=${glq2}&apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
                      ...
                      glw2 = gwh.split("|")[1];
                      reply(mess.wait)
                      anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=lionlogo&text1=${glw1}&text2=${glw2}&apikey=Jsieu8287362jshre82`, {method: 'get'})
                      buffers = await getBuffer(anu.result)
                      client.sendMessage(from, buffers, image, {quoted: mek})
                      break
				case 'leave': 
...
if (isBanned) return reply(mess.only.benned)    
               ...
               client.reply(from, `Waalaikumsalam wr.wb${pushname}:)`)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					anuf = await fetchJson(`https://mhankbarbars.herokuapp.com/api/text2image?text=${ttpl}&apiKey=beli api key biar work!`, {method: 'get'})
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
						...
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/nekonime?apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
						...
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/kiss?apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
						...
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/cry?apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
						...
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/waifu?apikey=Jsieu8287362jshre82`, {method: 'get'})
				    ...
				    try {
						...
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/hug?apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
						...
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/randomquotes?apikey=Jsieu8287362jshre82`, {method: 'get'})
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					...
					reply(mess.wait)
					anu = await fetchJson(`https://tobz-api.herokuapp.com/api/waifu?apikey=Jsieu8287362jshre82`, {method: 'get'})
					if (anu.error) return reply(anu.error)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					case 'nangis':
                                        ...
                                        ranp = getRandom('.gif')
                                        rano = getRandom('.webp')
                                        anu = await fetchJson('https://tobz-api.herokuapp.com/api/cry?apikey=Jsieu8287362jshre82', {method: 'get'})
                                        if (anu.error) return reply(anu.error)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPremium) return reply(mess.only.premium)
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/randomanime?apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPremium) return reply(mess.only.premium)
						if (!isNsfw) return reply('❌ *NSFW MATI* ❌')
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/hentai?apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPremium) return reply(mess.only.premium)
						if (!isNsfw) return reply('❌ *NSFW MATI* ❌')
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/nsfwblowjob?apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPremium) return reply(mess.only.premium)
						if (!isNsfw) return reply('❌ *NSFW MATI* ❌')
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/nsfwneko?apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPremium) return reply(mess.only.premium)
						if (!isNsfw) return reply('❌ *NSFW MATI* ❌')
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/nsfwtrap?apikey=Jsieu8287362jshre82`, {method: 'get'})
 ...
 if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
					...
					jhf = body.slice(10)
					reply(mess.wait)
					anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=jokerlogo&text=${jhf}&apikey=Jsieu8287362jshre82`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					gatauda = body.slice(8)
					reply(mess.wait)
					anu = await fetchJson(`https://tobz-api.herokuapp.com/api/randomanime?apikey=Jsieu8287362jshre82`, {method: 'get'})
          ...
          reply('Wait..')
                                       ...
                                       await fetchJson(`https://api-zeks.harispoppy.com/api/spamcall?no=`+data+`&apikey=Jsieu8287362jshre82`, {method: 'get'})
                                       break
					case 'infonomor':
					if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
			...
			if (isBanned) return reply(mess.only.benned)    
                ...
                if (!isPremium) return reply(mess.only.premium)
                reply(mess.wait)
                data = await fetchJson(`https://tobz-api.herokuapp.com/api/joox?q=${body.slice(6)}&apikey=Jsieu8287362jshre82`, {method: 'get'})
               if (data.error) return reply(data.error)
               ...
               if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                   ...
                   anu = await fetchJson(`https://tobz-api.herokuapp.com/api/infogempa?apikey=Jsieu8287362jshre82`, {method: 'get'})
                   if (anu.error) return reply(anu.error)
				...
				if (!isUser) return reply(mess.only.userB)
                   ...
                   teks = body.slice(5)
                   anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/githubprofile?user=${teks}&apikey=Jsieu8287362jshre82)`, {method: 'get'})
                   if (anu.error) return reply(anu.error)
				...
				case 'hackertext':
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=theme=matrix=${tels}&apiKey=Jsieu8287362jshre82`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
                case 'infocuaca':
				...
				if (!isUser) return reply(mess.only.userB)
                   ...
                   anu = await fetchJson(`https://mhankbarbars.herokuapp.com/api/cuaca?q=${body.slice(6)}&apiKey=beli api key biar work!`, {method: 'get'})
                   if (anu.error) return reply(anu.error)
...
if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
					...
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://tobz-api.herokuapp.com/api/hug?apikey=Jsieu8287362jshre82', {method: 'get'})
					if (anu.error) return reply(anu.error)
 ...
 if (isBanned) return reply(mess.only.benned)    
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					...
					setTimeout( () => {
					 client.sendMessage(from, 'siap siap ya VEERBOTZ Kick nih', text, { quoted: mek }) // ur cods
					}, 0) // 1000 = 10s,
					}
					break
				case 'aguse':
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                    ...
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=wood_block&text=${teks}&apikey=Jsieu8287362jshre82`, {method: 'get'})
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=quote_on_wood_heart&text=${teks}&apikey=Jsieu8287362jshre82`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			     	 case 'mutgrass':
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=message_under_the_grass&text=${teks}&apikey=Jsieu8287362jshre82`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
				...
				if (!isUser) return reply(mess.only.userB)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=underwater_ocean&text=${teks}&apikey=Jsieu8287362jshre82`, {method: 'get'})
                                         client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
                                case 'woodenboards':
                                        if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=wooden_boards&text=${teks}&apikey=Jsieu8287362jshre82`, {method: 'get'})
                                        client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
                                case 'wolfmetal':
                                           if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=wolf_metal&text=${teks}&apikey=Jsieu8287362jshre82`, {method: 'get'})
                                        client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
                                case 'metalictglow':
                                           if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=metalic_text_glow&text=${teks}&apikey=Jsieu8287362jshre82`, {method: 'get'})
                                        client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
                                case '8bit':
                                          if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=bit8&text=${teks}&text=${teks}&apikey=Jsieu8287362jshre82`, {method: 'get'})
                                        client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
                                case 'randomkpop':
                                        gatauda = body.slice(6)
                                        ...
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/randomkpop?apikey=Jsieu8287362jshre82`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                ...
                                case 'fml2':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        data = await fetchJson(`https://tobz-api.herokuapp.com/randomfmylife?apikey=Jsieu8287362jshre82`, {method: 'get'})
                                        hasil = `*Fuck My Life*\n${data.result}`
                                        reply(hasil)
                                        break
				case 'tiktokstalk':
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                    ...
                    anu = await fetchJson(`https://tobz-api.herokuapp.com/api/shorturl?url=${body.slice(10)}&apikey=Jsieu8287362jshre82`)
			        hasil = `${anu.result}`
			        reply(hasil)
			        break
			    case 'infonotlp':
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (teks.length > 8) return reply('Teksnya kepanjangan, maksimal 8 karakter')
					reply(mess.wait)
					anu = await fetchJson(`https://api-zeks.harispoppy.com/api/leavest?text=${teks}&apikey=Jsieu8287362jshre82`)
				...
				case 'tep':
					...
					if (teks.length > 8) return reply('Teksnya kepanjangan, maksimal 8 karakter')
					reply(mess.wait)
					anu = await fetchJson(`https://api-zeks.harispoppy.com/api/colortext?text=${teks}&apikey=Jsieu8287362jshre82`)
 ...
 if (!isOwner) return reply(mess.only.ownerB)
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘  VEERBOTZ 〙', members_id, true)
					break
				case 'clearall':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ *VEERBOTZ Broadcast* ]\n\n${body.slice(4)}`)
						}
						reply('Suksess broadcast')
					}
					break
	...
	.then(() => {client.sendMessage(from, options, text)})
				...
				//frendowner
				case `addadmin`:
                   if (!isOwner) return reply('Perintah ini hanya bisa di gunakan oleh Owner VEERBOTZ!', id)
                   for (let i = 0; i < mentionedJidList.length; i++) {
                   adminNumber.push(mentionedJidList[i])
                   fs.writeFileSync('./lib/database/admin.json', JSON.stringify(adminNumber))
                   reply('Success Menambahkan Admin VEERBOTZ!')
				   }
                   break
				case 'wait':
				if (isBanned) return reply(mess.only.benned)    
